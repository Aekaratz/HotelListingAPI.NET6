...
namespace HotelListing.Api.Repository
{
    public class AuthMananger : IAuthManager
    {
        ...
        public AuthMananger(IMapper mapper, UserManager<ApiUser> userManager, IConfiguration
            configuration)
        {
            this._mapper = mapper;
        ...
        public async Task<AuthResponeDto> Login(LoginDto loginDto)
        {
        ...
        public async Task<AuthResponeDto> VerifyRefreshToken(AuthResponeDto request)
        {
